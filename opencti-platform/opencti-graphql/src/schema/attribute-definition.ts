...
// TODO: draft update metadata model needs to be refined
// export const draftUpdatePatch: AttributeDefinition = {
//   name: 'draft_update_patch',
...
//   isFilterable: false,
//   mappings: [
//     { name: 'op', label: 'Draft patch operation', type: 'string', format: 'short', mandatoryType: 'external',
//     editDefault: false, multiple: false, upsert: false, isFilterable: false },
//     { name: 'path', label: 'Draft patch path', type: 'string', format: 'short', mandatoryType: 'external',
//     editDefault: false, multiple: false, upsert: false, isFilterable: false },
//     { name: 'value', label: 'Draft patch value', type: 'string', format: 'short', mandatoryType: 'external',
//     editDefault: false, multiple: true, upsert: false, isFilterable: false },
//   ]
// };
